...
**Your Task:**
Build the Lifestyle Care Plan: Exercise Regimen card (EMR-006) in src/components/lifestyle/exercise-regimen-card.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-18-exercise`
