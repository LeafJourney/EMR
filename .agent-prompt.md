...
**Your Task:**
Build the Lifestyle Care Plan: Sleep Hygiene card (EMR-006) in src/components/lifestyle/sleep-hygiene-card.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-16-sleep`
