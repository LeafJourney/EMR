...
**Your Task:**
Build the Follow-up Interval Picker component (EMR-072) in src/components/clinical/soap/follow-up-selector.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-53-followup`
