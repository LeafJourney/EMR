...
**Your Task:**
Build a Gamified Plant Companion visual component (EMR-022) in src/components/gamification/plant-companion.tsx.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-11-plant`
