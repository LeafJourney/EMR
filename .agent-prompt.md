...
**Your Task:**
Create the Medicare CBD Reimbursement rules engine (EMR-047) in src/lib/billing/medicare-cbd-rules.ts.
...
5. Once tests pass, commit your code to this branch with `git add . && git commit -m "feat: $(your ticket)" && git push -u origin feat/swarm-25-medicare`
