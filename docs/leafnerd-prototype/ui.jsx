...
window.Badge = function Badge({ tone = "gray", children, dot = true, mono = false, outline = false }) {
...
/* confidence meter */
window.Conf = function Conf({ value, showPct = true }) {
...
/* sparkline */
window.Sparkline = function Sparkline({ data, w = 90, h = 30, color = "var(--c-canopy)", fill = true }) {
...
/* radial gauge */
window.Gauge = function Gauge({ value, size = 92, label, color = "var(--c-canopy)" }) {
...
window.BarsH = function BarsH({ data }) {
...
window.AreaChart = function AreaChart({ data, w = 560, h = 180, color = "var(--c-canopy)", labels = [], yMax }) {
