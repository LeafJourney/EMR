...
**Still open on billing (own pass):** Generate Tax Documents (1099/W9) + email/save-to-Correspondence (M, regulatory), payment-method completions (ACH routing/account fields, Bitcoin wallet, Print/Save invoice, cash/check → Correspondence), Insurance **Directory** + click-to-call (telephony), per-statement/event-log share+print, "Cindy suggests" reimbursement-probability AI panel.
